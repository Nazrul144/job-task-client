...
const Login = () => {
	...
	<form noValidate="" action="" className="space-y-12">
		<div className="space-y-4">
			<div>
				<label htmlFor="email" className="block mb-2 text-sm">Email address or Phone</label>
		...
		<div className="space-y-2">
            ...
            <Link to='/register'> <button rel="noopener noreferrer" href="#" className="hover:underline dark:text-violet-600 font-bold">Register</button>.
            </Link>
			</p>
		</div>
	</form>
