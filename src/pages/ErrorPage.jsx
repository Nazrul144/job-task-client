...
import errorImg from '../../src/assets/errorPage.jpg'
const ErrorPage = () => {
    return (
      <section className='bg-white '>
        <div className='container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12'>
          <div className='wf-ull lg:w-1/2'>
            <p className='text-sm font-medium text-gray-500 font-poppins'>404 error</p>
            ...
            <p className='mt-4 text-black dark:text-gray-400'>
              Opps! this page is not available right now!
            </p>
